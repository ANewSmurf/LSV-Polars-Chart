...
var PolarsApp = (function(){
  ...
  const tolerance = 1.014;
	...
	function plotPolarsChart() {
      ...
      $(".sail.Jib"		).next().next().text(data.sailsSpeeds.Jib		.fix(_current_nbdigits, true) +  ( ( (data.sailsSpeeds.Jib*tolerance>_current_boatspeed) && (data.sailsSpeeds.Jib!=_current_boatspeed)) ? (' (' +_current_boatspeed.fix(_current_nbdigits, true) + ')' ) : "")  )  ;
            $(".sail.LightJib"	).next().next().text(data.sailsSpeeds.LightJib	.fix(_current_nbdigits+1, true) +  ( ( _chk_opt_light && (data.sailsSpeeds.LightJib*tolerance>_current_boatspeed) && (data.sailsSpeeds.LightJib!=_current_boatspeed)) ? (' (' +_current_boatspeed.fix(_current_nbdigits, true) + ')' ) : "")  )  ;
            $(".sail.Staysail"	).next().next().text(data.sailsSpeeds.Staysail	.fix(_current_nbdigits+1, true) +  ( ( _chk_opt_heavy && (data.sailsSpeeds.Staysail*tolerance>_current_boatspeed) && (data.sailsSpeeds.Staysail!=_current_boatspeed)) ? (' (' +_current_boatspeed.fix(_current_nbdigits, true) + ')' ) : "")  )  ;
            $(".sail.Code0"		).next().next().text(data.sailsSpeeds.Code0		.fix(_current_nbdigits+1, true) +  ( ( _chk_opt_reach && (data.sailsSpeeds.Code0*tolerance>_current_boatspeed) && (data.sailsSpeeds.Code0!=_current_boatspeed)) ? (' (' +_current_boatspeed.fix(_current_nbdigits, true) + ')' ) : "")  )  ;
            $(".sail.Spi"		).next().next().text(data.sailsSpeeds.Spi		.fix(_current_nbdigits+1, true) +  ( ((data.sailsSpeeds.Spi*tolerance>_current_boatspeed) && (data.sailsSpeeds.Spi!=_current_boatspeed)) ? (' (' +_current_boatspeed.fix(_current_nbdigits, true) + ')' ) : "")  )  ;
            $(".sail.LightGnk"	).next().next().text(data.sailsSpeeds.LightGnk	.fix(_current_nbdigits+1, true) +  ( ( _chk_opt_light && (data.sailsSpeeds.LightGnk*tolerance>_current_boatspeed) && (data.sailsSpeeds.LightGnk!=_current_boatspeed)) ? (' (' +_current_boatspeed.fix(_current_nbdigits, true) + ')' ) : "")  )  ;
            $(".sail.HeavyGnk"	).next().next().text(data.sailsSpeeds.HeavyGnk	.fix(_current_nbdigits+1, true) +  ( ( _chk_opt_heavy && (data.sailsSpeeds.HeavyGnk*tolerance>_current_boatspeed) && (data.sailsSpeeds.HeavyGnk!=_current_boatspeed)) ? (' (' +_current_boatspeed.fix(_current_nbdigits, true) + ')' ) : "")  )  ;
